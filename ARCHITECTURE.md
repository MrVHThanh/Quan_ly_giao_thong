...
### Schema 13 bảng (cột thực tế từ DB)
...
4. Starlette ExceptionMiddleware (built-in)
5. Starlette ServerErrorMiddleware (built-in)
```
...
cp .env.example .env
# Điền SESSION_SECRET, DEBUG=false, DB_PATH, ALLOWED_ORIGINS
